...
export default function useGoogleAuth( code: string = "") {
    if (code === "") window.location.href = "https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=http://localhost:5173/auth/google/&prompt=consent&response_type=code&client_id=4683390329-dtki8jkel6or719qi6fk7qrnp8dvnven.apps.googleusercontent.com&scope=openid%20email%20profile&access_type=offline"
    else {
